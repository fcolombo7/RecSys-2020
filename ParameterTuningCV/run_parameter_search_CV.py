...
from ParameterTuningCV.SearchBayesianSkopt import SearchBayesianSkopt
from ParameterTuningCV.SearchSingleCase import SearchSingleCase
from ParameterTuningCV.SearchAbstractClass import SearchInputRecommenderArgs
...
def runParameterSearch_Content(recommender_class, URM_train, ICM_object, ICM_name, URM_train_last_test = None,
                             ...
                             similarity_type_list = None, k = 5, seed = None):
