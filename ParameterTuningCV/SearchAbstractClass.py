...
class SearchAbstractClass(object):
    ...
    def _fit_model(self, current_fit_parameters, index):
    ...
    def _evaluate_on_validation(self, current_fit_parameters, index):
        ...
        result_dict, _ = self.evaluator_list[index].evaluateRecommender(recommender_instance)
    ...
    def _objective_function(self, current_fit_parameters_dict):
        ...
        try:
            ...
            for i in range(self.k):
                ...
                recommender_instance_list.append(recommender_instance_temp)
