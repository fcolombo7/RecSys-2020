...
class SSLIM_BPR_Cython(BaseItemSimilarityMatrixRecommender, Incremental_Training_Early_Stopping):

    RECOMMENDER_NAME = "S-SLIM_BPR_Rec"
    ...
    def __init__(self, URM_train,
        ...
        super(SSLIM_BPR_Cython, self).__init__(URM_train, verbose = verbose)
    ...
    def fit(self, alpha = 0.5,
        ...
        self.URM_train = virtual_URM.tocsr()
