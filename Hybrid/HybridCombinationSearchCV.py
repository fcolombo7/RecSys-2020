...
class HybridCombinationSearchCV(BaseItemSimilarityMatrixRecommender):
    ...
    def fit(self, alpha=0.5, l1_ratio=0.5, normalize = False):
...
class HybridCombinationSearchCV2(BaseItemSimilarityMatrixRecommender):
    RECOMMENDER_NAME = "HybridCombinationSearchCV"
    ...
    def __init__(self, URM_train, ICM_train, list_rec, seed=None, fold=None, submission=False, verbose=True):
        ...
        super(HybridCombinationSearchCV2, self).__init__(URM_train, verbose=verbose)
        self.URM_train = URM_train
        self.ICM_train = ICM_train
    ...
    def fit(self, a=0.5, b=0.5, c=0.5, normalize=False):
        self.__a = a
        self.__b = b
        self.__c = c
        self.normalize = normalize
