...
class LinearHybrid005(BaseItemSimilarityMatrixRecommender):
    RECOMMENDER_NAME = "LinearHybrid005"
    ...
    def __init__(self, URM_train, ICM_train, submission=False, verbose=True, seed=1205):
        ...
        self.__rec1_params = {'topK': 1000, 'alpha': 0.38192761611274967, 'beta': 0.0, 'normalize_similarity': False}

        self.__rec2 = P3alphaRecommender(URM_train, verbose=False)
        self.__rec2_params = {'topK': 131, 'alpha': 0.33660811631883863, 'normalize_similarity': False}
