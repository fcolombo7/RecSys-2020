...
class UserWiseHybrid006(BaseRecommender):
    RECOMMENDER_NAME = "UserWiseHybrid006" #5 Range

    def __init__(self, URM_train, ICM_train, submission=False, verbose=True, seed=1205):
        super(UserWiseHybrid006, self).__init__(URM_train, verbose=verbose)
        recommenders = {
        ...
        self.__recommender_segmentation = [
            ((0,4), HiddenRecommender(URM_train, ICM_train, [
                recommenders['p3a'],
                recommenders['ucf'],
                recommenders['icb']
            ...
            ((4,7), HiddenRecommender(URM_train, ICM_train, [
                recommenders['ucf'],
                recommenders['icb'],
                recommenders['sbpr']
            ], submission=submission, verbose=verbose, seed=seed),
            ...
            ((7,13), HiddenRecommender(URM_train, ICM_train, [
                recommenders['ucf'],
                recommenders['icb'],
                recommenders['sen']
            ], submission=submission, verbose=verbose, seed=seed),
            ...
            ((13,26), HiddenRecommender(URM_train, ICM_train, [
                recommenders['icb'],
                recommenders['sen'],
                recommenders['sbpr']
            ], submission=submission, verbose=verbose, seed=seed),
            ...
            ((26,-1), HiddenRecommender(URM_train, ICM_train, [
                recommenders['icf'],
                recommenders['icb'],
                recommenders['sen']
            ], submission=submission, verbose=verbose, seed=seed),
