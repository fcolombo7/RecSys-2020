...
class LinearHybrid004(BaseItemSimilarityMatrixRecommender):
    RECOMMENDER_NAME = "LinearHybrid004"
    ...
    def __init__(self, URM_train, ICM_train, submission=False, verbose=True, seed=1205):
        super(LinearHybrid004, self).__init__(URM_train, verbose = verbose)
        ...
        self.__rec2 = RP3betaRecommender(URM_train, verbose=False)
        self.__rec2_params = {'topK': 1000, 'alpha': 0.38192761611274967, 'beta': 0.0, 'normalize_similarity': False}
