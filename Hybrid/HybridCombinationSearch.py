...
class LinearHybrid002ggg(BaseItemSimilarityMatrixRecommender):
    RECOMMENDER_NAME = "LinearHybrid002ggg"
    ...
    def __init__(self, URM_train, ICM_train, submission=False, verbose=True, seed=1205):
        super(LinearHybrid002ggg, self).__init__(URM_train, verbose = verbose)
