...
class UserWiseHybrid002(BaseRecommender):
    RECOMMENDER_NAME = "UserWiseHybrid002"

    def __init__(self, URM_train, ICM_train, submission=False, verbose=True, seed=1205):
        super(UserWiseHybrid002, self).__init__(URM_train, verbose=verbose)
        self.__recommender_segmentation = [
            ((0, 3),
             LinearHybridC001(URM_train, ICM_train, submission=submission, verbose=verbose, seed=seed),
