...
from Hybrid.LinearHybrid003 import LinearHybrid003
...
class ColdUserEmbedding001(BaseRecommender):
    ...
    def __init__(self, URM_train, ICM_train, submission=False, verbose=True, seed=1205):
        ...
        self.__warm_recommender = LinearHybrid003(URM_train, ICM_train, submission=submission, verbose=verbose,
                                                  seed=seed)
        self.__warm_params = {'alpha': 0.4357334022190923, 'l1_ratio': 0.7855628829453338}
